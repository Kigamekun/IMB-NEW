        ...
        <div style="width: 90%;margin:auto">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5 rounded">
                <div class="p-6 text-gray-900">
                    <div class="container">
                        <h1 class="text-center">Rekap Register IMB Per Tahun</h1>
                        <br>


                        <form id="rekapForm" method="GET" action="{{ route('rekap.RegisterIMBPerTahunStore') }}">
                            <div class="row">
                                <div class="col-md-6 ">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <button type="submit" name="submit_type" value="pecahan" class="btn btn-success btn-block">
                                Detail IMB Pecahan
                            </button>
                        </div>
                        <div class="col-md-4">
                            <button type="submit" name="submit_type" value="perluasan" class="btn btn-warning btn-block">
                                Detail IMB Perluasan
                            </button>
                        </div>
                    </div>
                    </form>
