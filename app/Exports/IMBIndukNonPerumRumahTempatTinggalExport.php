...
use App\Models\IMBIndukNonPerumRumahTempatTinggal;

class IMBIndukNonPerumRumahTempatTinggalExport implements ShouldAutoSize,FromCollection, WithCustomStartCell, WithEvents
{
    ...
    public function registerEvents(): array {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('G1', "Surat Izin Nomor");
    ...
    {
        return IMBIndukNonPerumRumahTempatTinggal::select(
            'id',
            'nama',
            'letak_bangunan',
            'jenis_bangunan',
