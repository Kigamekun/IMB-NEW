...
@section('content')
        ...
        <div style="width: 90%;margin:auto">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5 rounded">
                <div class="p-6 text-gray-900">
                    <h3 class="text-3xl font-bold">Data IMB Induk Non Perum</h3>
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('IMBIndukNonPerum.create') }}" type="button" class="btn btn-primary">
                            Tambah Data
                        </a>
                        ...
                        <a class="btn btn-warning ml-2" href="{{ route('IMBIndukNonPerum.export') }}">
                            Export Data
                        </a>
                    ...
                    <div class="table-responsive py-3">
                        <div class="filters py-3 row">
                            ...
                            <div class="mb-3 col-md-3" style="margin-top: 10px; margin-bottom:10px">
    ...
    <script>
        var table = $('#IMBTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('IMBIndukNonPerum.index') }}",
            },
            columns: [{
                    data: 'DT_RowIndex',
                    orderable: false,
    ...
    <script>
        $(document).on('click', '.show-items-btn', function() {
            ...
            $.ajax({
                url: '{{ route('IMBIndukNonPerum.items') }}' + '?id=' +
