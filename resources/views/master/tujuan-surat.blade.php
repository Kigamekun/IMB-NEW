        ...
        $('#updateData').on('shown.bs.modal', function(e) {
            ...
            <form action="${$(e.relatedTarget).data('url')}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                            <label for="nama" class="fw-semibold">Name <span class="ml-1 text-danger">*</span></label>
                            <input type="text" class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" value="${$(e.relatedTarget).data('nama')}"
                                id="nama" name="nama" placeholder="Masukan Name">
